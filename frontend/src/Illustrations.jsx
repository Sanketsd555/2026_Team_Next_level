const P = {
  ...
  refresh: [
    <path key="a" d="M21 12a9 9 0 1 1-2.64-6.36L21 8" />,
  ...
  coins: [
    <ellipse key="a" cx="12" cy="5" rx="8" ry="3" />,
    <path key="b" d="M4 5v7c0 1.7 3.6 3 8 3s8-1.3 8-3V5" />,
    <path key="c" d="M4 12v7c0 1.7 3.6 3 8 3s8-1.3 8-3v-7" />,
  ],
  chart: [
  ...
  bell: [
    <path key="a" d="M18 8a6 6 0 0 0-12 0c0 7-3 9-3 9h18s-3-2-3-9" />,
    <path key="b" d="M13.7 21a2 2 0 0 1-3.4 0" />,
  ],
  arrow: [
  ...
  play: [
    <path key="a" d="M5 3l14 9-14 9V3z" />,
  ],
  percent: [
    <path key="a" d="M19 5L5 19" />,
    <circle key="b" cx="7" cy="7" r="2.5" />,
    <circle key="c" cx="17" cy="17" r="2.5" />,
  ],
  info: [
    <circle key="a" cx="12" cy="12" r="9" />,
    <path key="b" d="M12 11v6" />,
    <path key="c" d="M12 7h.01" />,
  ],
  landmark: [
  ...
  layers: [
    <path key="a" d="M12 2l9 5-9 5-9-5 9-5z" />,
    <path key="b" d="M3 12l9 5 9-5" />,
    <path key="c" d="M3 17l9 5 9-5" />,
  ],
  rupee: [],
  chat: [
  ...
  alert: [
    <path key="a" d="M10.3 3.9L1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0z" />,
...
const iconShell = (art) => (
  <svg role="img" aria-label="Loan icon" viewBox="0 0 120 120" width="120" height="120">
    <rect x="8" y="8" width="104" height="104" rx="20" fill="#16191f" stroke="#2a2e37" />
    {art}
  </svg>
)
...
export function AdIcon({ title }) {
  ...
  if (lower.includes('home')) {
    art = (
      <g key="home">
        <rect x="28" y="48" width="64" height="44" rx="4" fill="#0f172a" />
        <path d="M18 54l42-30 42 30" fill="none" stroke="#4ade80" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
        <rect x="48" y="66" width="24" height="26" rx="3" fill="#3b82f6" />
        <circle cx="60" cy="79" r="3" fill="#fbbf24" />
        <path d="M70 48h16v14h-16z" fill="#fbbf24" />
      </g>
    )
  } else if (lower.includes('wheeler') || lower.includes('vehicle')) {
    art = (
      <g key="vehicle">
        <path d="M20 78c0-9 7-16 16-16h42l10 16" fill="none" stroke="#3b82f6" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M70 62l-8-22H42l-6 22" fill="none" stroke="#e2e8f0" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
        <circle cx="38" cy="84" r="10" fill="none" stroke="#4ade80" strokeWidth="5" />
        <circle cx="82" cy="84" r="10" fill="none" stroke="#4ade80" strokeWidth="5" />
        <circle cx="38" cy="84" r="3" fill="#4ade80" />
        <circle cx="82" cy="84" r="3" fill="#4ade80" />
      </g>
    )
  } else if (lower.includes('business')) {
    art = (
      <g key="business">
        <rect x="28" y="44" width="64" height="46" rx="6" fill="#0f172a" />
        <path d="M42 44v-8a6 6 0 0 1 6-6h24a6 6 0 0 1 6 6v8" fill="none" stroke="#3b82f6" strokeWidth="5" strokeLinecap="round" />
        <circle cx="60" cy="68" r="9" fill="none" stroke="#4ade80" strokeWidth="5" />
        <path d="M55 68l4 4 6-7" fill="none" stroke="#4ade80" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
      </g>
    )
  } else if (lower.includes('gold')) {
    art = (
      <g key="gold">
        <circle cx="60" cy="62" r="30" fill="#fbbf24" />
    ...
    art = (
      <g key="banknote">
        <rect x="24" y="40" width="72" height="44" rx="8" fill="#3b82f6" />
        <rect x="30" y="46" width="60" height="32" rx="5" fill="#0f172a" />
        <circle cx="60" cy="62" r="9" fill="none" stroke="#fbbf24" strokeWidth="4" />
        <text x="60" y="66" textAnchor="middle" fontSize="14" fontWeight="700" fill="#fbbf24">₹</text>
      </g>
    )
  } else {
    art = (
      <g key="coin">
        <ellipse cx="60" cy="44" rx="34" ry="12" fill="#0f172a" />
        <ellipse cx="60" cy="56" rx="34" ry="12" fill="#fbbf24" />
        <ellipse cx="60" cy="68" rx="34" ry="12" fill="#fbbf24" />
        <ellipse cx="60" cy="80" rx="34" ry="12" fill="#0f172a" />
...
export function HeroArt() {
  return (
    <svg viewBox="0 0 360 240" width="360" height="240" role="img" aria-label="Loan and banking illustration" className="hero-art">
      <defs>
      ...
      <circle cx="300" cy="40" r="60" fill="#3b82f6" opacity="0.12" />
      <circle cx="40" cy="210" r="70" fill="#10b981" opacity="0.10" />

      <g transform="translate(40 60)">
        <path d="M4 96h112M16 96V68h88v28" fill="none" stroke="#e6e9ee" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M10 68l52-34 52 34" fill="none" stroke="#4ade80" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
        <g stroke="#e6e9ee" strokeWidth="5" strokeLinecap="round">
      ...
      <path d="M64 196h70" stroke="#2a2e37" strokeWidth="3" strokeLinecap="round" />
      <path d="M64 196l40-44 22 14 30-40" fill="none" stroke="#4ade80" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
      <circle cx="156" cy="126" r="6" fill="#4ade80" />
      <path d="M152 112l-3 9 9 3" fill="none" stroke="#4ade80" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />

      <g transform="rotate(-8 292 170)">
        <rect x="248" y="150" width="88" height="56" rx="9" fill="url(#card)" />
        <rect x="258" y="162" width="26" height="18" rx="3" fill="#fbbf24" />
        <rect x="258" y="188" width="40" height="7" rx="3.5" fill="#e6e9ee" opacity="0.7" />
        <path d="M314 160h10M314 168h10" stroke="#e6e9ee" strokeWidth="3" strokeLinecap="round" opacity="0.5" />
      </g>
    </svg>
  )
}
