# Generated by Django 4.2.30 on 2026-08-05 10:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'User'), ('bank', 'Bank'), ('admin', 'Admin')], default='user', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_amount', models.PositiveIntegerField(default=1000)),
                ('max_amount', models.PositiveIntegerField(default=100000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bank_applications', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
