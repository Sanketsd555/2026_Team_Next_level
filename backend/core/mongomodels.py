...
class LoanApplication(mongoengine.Document):
    ...
    pan_enc = mongoengine.StringField(default="")
    aadhar_enc = mongoengine.StringField(default="")
    ...
    risk_score = mongoengine.IntField(default=0)
    risk_level = mongoengine.StringField(max_length=16, default="LOW")
    fraud_detected = mongoengine.BooleanField(default=False)
    fraud_flags = mongoengine.ListField(mongoengine.DictField(), default=list)
    ai_reason = mongoengine.StringField(default="")
    auto_rejected = mongoengine.BooleanField(default=False)
    analysis_at = mongoengine.DateTimeField(default=None)
    analysis_ms = mongoengine.FloatField(default=0.0)
    ...
    chain_write_ms = mongoengine.FloatField(default=0.0)
    created_at = mongoengine.DateTimeField(default=datetime.utcnow)
